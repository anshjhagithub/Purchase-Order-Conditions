  ...
  lines: [
    {
      ...
      invoiceQty: 0,
      conditions: [
        fromMaster('VOL-DISC', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 10 }),
        fromMaster('FUEL-SURC', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 20 }),
        fromMaster('OCEAN-FRT', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 30, rate: 500, qty: 16, status: 'Confirmed', confirmedPct: 100 }),
        fromMaster('MARINE-INS', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 40 }),
        fromMaster('BCD', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 50 }),
        fromMaster('SWS', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 60 }),
        fromMaster('IMPORT-IGST', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 70 }),
        fromMaster('CHA-FEE', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 80, status: 'Confirmed', confirmedPct: 100 }),
        fromMaster('RETENTION', { id: 'ven-apex', name: 'Apex Battery Components Pte Ltd' }, { level: 'LINE', lineId: po2Line1Id, sequence: 90 }),
      ],
    },
  ],
  headerConditions: [],
